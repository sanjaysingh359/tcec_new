...
export default function CategoryWisePage() {
  ...
  function handleGenerate(e) {
    ...
    navigate('/app/reports/trainees/category/report', { state: { month, monthName, year } });
  }

  return (
    <div className="gr-page">
      <div className="gr-title-bar">Category wise Trainees Trained report of MSME-AB</div>
