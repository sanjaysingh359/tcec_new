...
export default function QualificationWisePage() {
  ...
  function handleGenerate(e) {
    ...
    navigate('/app/reports/trainees/qualification/report', { state: { month, monthName, year } });
  }

  return (
    <div className="gr-page">
      <div className="gr-title-bar">Qualification wise Trainees Trained report of MSME-AB</div>
